...
test-crash-reporting-gating:
	mkdir -p .build
	swiftc Sources/KeyMic/Telemetry/CrashReportingCore.swift \
	       Tests/CrashReportingGatingTests.swift \
	       -o .build/crash-reporting-gating-tests
	.build/crash-reporting-gating-tests

test-crash-reporting-scrub:
	mkdir -p .build
	swiftc Sources/KeyMic/Telemetry/CrashReportingCore.swift \
	       Tests/CrashReportingScrubTests.swift \
	       -o .build/crash-reporting-scrub-tests
	.build/crash-reporting-scrub-tests
